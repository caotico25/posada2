...
<html>
    ...
    <head>
        ...
        <title>Posada del Caos - Alta de noticia</title>
                ...
                <section class="content">
                    ...
                    <article class="box">
                        <div class="box-header with-border">
                            <h3 class="box-title">Datos de la nueva noticia</h3>
                        </div>
                        <div class="box-body">
                            ...
                            <form role="form" class="form-horizontal">
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="col-sm-6">
                                        <input class="form-control" type="text" name="titulo" value="" id="titulo" placeholder="Titulo"/>
                                    </div>
                                </div>
                                <div class="form-group has-feedback">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-offset-2 col-sm-6">
                                        <button id="crear_noticia" type="submit" class="btn btn-primary">Crear</button>
                                    </div>
                                </div>
                            </form>
                ...
                $("#crear_noticia").on('click', function(event) {
                    ...
                    if (titulo_valido && contenido_valido)
                    {
                        $.ajax({
                            ...
                            url: "<?= base_url('noticias/nueva_noticia') ?>",
                            type: "POST",
