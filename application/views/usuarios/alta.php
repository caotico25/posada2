...
<html>
    ...
    <head>
        ...
        <title>Posada del Caos - Alta de usuario</title>
                ...
                <section class="content">
                    ...
                    <article class="box">
                        <div class="box-header with-border">
                            <h3 class="box-title">Datos del nuevo usuario</h3>
                        </div>
                        <div class="box-body">
                            ...
                            <form role="form" class="form-horizontal">
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="col-sm-6">
                                        <input class="form-control" type="text" name="usuario" value="" id="usuario" placeholder="Usuario"/>
                                    </div>
                                </div>
                                <div class="form-group has-feedback">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-offset-2 col-sm-6">
                                        <button id="crear_usuario" type="submit" class="btn btn-primary">Crear</button>
                                    </div>
                                </div>
                            </form>
        ...
        <script type="text/javascript" charset="utf-8">
            ...
            $(document).ready(function() {
                ...
                $("#r-passwd").on('blur', function() {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            $(this).parent().children('.fa-check').remove();
                            $(this).parent().append('<span class="fa fa-times form-control-feedback"></span>');
                            $(this).tooltip('destroy').tooltip({'title': 'Las contraseñas no coinciden.'});
                        }
                    }
                ...
                $("#crear_usuario").on('click', function(event) {
                    ...
                    $("#email").trigger('blur');
                    $("#passwd").trigger('blur');
                    $("#r-passwd").trigger('blur');
                    $("#tipo").trigger('blur');
                    
                    var usuario_valido = $("#usuario").parent().parent().hasClass("has-success");
                    var email_valido = $("#email").parent().parent().hasClass("has-success");
                    var passwd_valido = $("#passwd").parent().parent().hasClass("has-success");
                    var r_passwd_valido = $("#r-passwd").parent().parent().hasClass("has-success");
                    var tipo_valido = $("#tipo").parent().parent().hasClass("has-success");
                    
                    if (usuario_valido && email_valido && passwd_valido && r_passwd_valido && tipo_valido)
                    {
                        $.ajax({
                        
                            url: "<?= base_url('usuarios/nuevo_usuario') ?>",
                            type: "POST",
                            data: { 'usuario': usuario, 'email': email, 'passwd': passwd, 're_passwd': r_passwd, 'admin': tipo },
