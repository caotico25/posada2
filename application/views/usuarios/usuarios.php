...
<html>
    ...
    <head>
        ...
        <title>Posada del Caos - Usuarios</title>
                    ...
                    <article class="box">
                        <div class="box-header with-border">
                            ...
                            <div class="box-tools pull-right">
                                <a href="<?= base_url('usuarios/alta') ?>" class="btn btn-box-tool" data-toggle="tooltip" title="Nuevo usuario"><i class="fa fa-plus"> Nuevo</i></a>
                            </div>
                        </div>
                        <div class="box-body">
                                ...
                                <tbody>
                                    <?php foreach ($usuarios as $usuario): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-sm btn-default" href="<?= base_url('usuarios/editar/' . $usuario['id']) ?>" data-toggle="tooltip" title="Editar"><i class="fa fa-edit"></i></a>
                                                <a class="btn btn-sm btn-default" href="<?= base_url('usuarios/eliminar/' . $usuario['id']) ?>" data-toggle="tooltip" title="Eliminar"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
                                    <?php endforeach ?>
                                </tbody>
