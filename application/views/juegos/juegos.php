...
<html>
    ...
    <head>
        ...
        <title>Posada del Caos - Juegos</title>
            ...
            <div class="container">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Administración de juegos</li>
                    </ol>
                </section>
                    ...
                    <article class="box">
                        <div class="box-header with-border">
                            ...
                            <div class="box-tools pull-right">
                                <a href="<?= base_url('juegos/alta') ?>" class="btn btn-box-tool" data-toggle="tooltip" title="Nuevo juego"><i class="fa fa-plus"> Nuevo</i></a>
                            </div>
                        </div>
                        <div class="box-body">
                                ...
                                <tbody>
                                    <?php foreach ($juegos as $juego): ?>
                                        <tr>
                                        	...
                                        	<td>
                                        	    <a class="btn btn-sm btn-default" href="<?= base_url('juegos/eliminar/' . $juego['id']) ?>" data-toggle="tooltip" title="Eliminar"><i class="fa fa-trash"></i></a>
                                        	</td>
                                        </tr>
                                    <?php endforeach ?>
                                </tbody>
