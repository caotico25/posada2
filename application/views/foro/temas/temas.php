...
<html>
    ...
    <head>
        ...
        <title>Posada del Caos - Temas</title>
            ...
            <div class="container">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Administración de temas</li>
                    </ol>
                </section>
                    ...
                    <article class="box">
                        <div class="box-header with-border">
                            ...
                            <div class="box-tools pull-right">
                                <a href="<?= base_url('foro/nuevo_tema') ?>" class="btn btn-box-tool" data-toggle="tooltip" title="Nuevo tema"><i class="fa fa-plus"> Nuevo</i></a>
                            </div>
                        </div>
                        <div class="box-body">
                                ...
                                <tbody>
                                    <?php foreach ($temas as $tema): ?>
                                        <tr>
                                            ...
                                            <td><?= $tema['seccion']['titulo'] ?></td>
                                            <td>
                                                <a class="btn btn-sm btn-default" href="<?= base_url('foro/editar_tema/' . $tema['id']) ?>" data-toggle="tooltip" title="Editar"><i class="fa fa-edit"></i></a>
                                                <span data-toggle="modal" data-target="#modal_eliminar">
                                                    <button class="eliminar btn btn-sm btn-default" data-href="<?= base_url('foro/eliminar_tema/' . $tema['id']) ?>" data-toggle="tooltip" title="Eliminar"><i class="fa fa-trash"></i></a>
                                                </span>
                                            </td>
                                        </tr>
                                    <?php endforeach ?>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">¿Confirmar la eliminación?</h4>
                    </div>
                    <div class="modal-body">
                        <p>¡Atención! Si elimina este tema se eliminarán tambien sus posts.</p>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal" >Cancelar</button>
                        <a id="aceptar_eliminar" class="btn btn-success" href="">Aceptar</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <script type="text/javascript" charset="utf-8">
            $(document).ready(function() {
                ...
                $("#modal_eliminar").on('show.bs.modal', function(e) {
                    ...
                    $(this).find('#aceptar_eliminar').attr('href', $(e.relatedTarget).children('button').data('href'));
