...
<html>
    ...
    <head>
        ...
        <title>Posada del Caos - Editar tema</title>
    ...
    <body role="document" class="layout-boxed skin-blue rellenar">
            ...
            <div class="container rellenar">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="<?= base_url('foro/administrar_temas') ?>">Administrar temas</a></li>
                        ...
                        <div class="box-body">
                            ...
                            <form role="form" class="form-horizontal">
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="col-sm-6">
                                        <input class="form-control" type="text" value="<?= $tema['titulo'] ?>" maxlength="50" name="titulo" value="" id="titulo" placeholder="Titulo"/>
                                    </div>
                                </div>
                                <div class="form-group has-feedback">
                                    <label for="descripcion" class="col-sm-2 required">Descripción</label>
                                    <div class="col-sm-6">
                                        <input type="text" maxlength="100" value="<?= $tema['descripcion'] ?>" class="form-control" name="descripcion" id="descripcion" placeholder="Descripcion" />
                                    </div>
                                </div>
                                <div class="form-group has-feedback">
                                    <label for="seccion" class="col-sm-2 required">Sección</label>
                                    <div class="col-sm-6">
                                        <select class="form-control" name="seccion" id="seccion">
                                            <option value="">Seleccionar...</option>
                                            <?php foreach ($secciones as $seccion): ?>
                                                <option value="<?= $seccion['id'] ?>" <?php if ($tema['seccion'] == $seccion['id']) { echo 'selected'; } ?>><?= $seccion['titulo'] ?></option>
                                            <?php endforeach ?>
                                ...
                                <div class="form-group">
                                    <div class="col-sm-offset-2 col-sm-6">
                                        <button id="crear_seccion" type="submit" class="btn btn-primary">Editar</button>
                                    </div>
                                </div>
                            </form>
        ...
        <script type="text/javascript" charset="utf-8">
            ...
            $(document).ready(function() {
                ...
                $("#crear_seccion").on('click', function(event) {
                    ...
                    $("#seccion").trigger('blur');
                    
                    var titulo_valido = $("#titulo").parent().parent().hasClass("has-success");
                    var descripcion_valido = $("#descripcion").parent().parent().hasClass("has-success");
                    var seccion_valido = $("#seccion").parent().parent().hasClass("has-success");
                    
                    if (titulo_valido && descripcion_valido && seccion_valido)
                    {
                        $.ajax({
                        
                            url: "<?= base_url('foro/edit_tema/' . $tema['id']) ?>",
                            type: "POST",
                            data: { 'titulo': titulo, 'descripcion': descripcion, 'seccion': seccion },
                            success: function (respuesta){
                                
                                window.location.href = "<?= base_url('foro/administrar_temas') ?>";
