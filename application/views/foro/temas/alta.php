...
<html>
    ...
    <head>
        ...
        <title>Posada del Caos - Alta de tema</title>
            ...
            <div class="container rellenar">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Alta de tema</li>
                    </ol>
                </section>
                ...
                <section class="content">
                    ...
                    <article class="box">
                        <div class="box-header with-border">
                            <h3 class="box-title">Datos del nuevo tema</h3>
                        </div>
                        <div class="box-body">
                            ...
                            <form role="form" class="form-horizontal">
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="col-sm-6">
                                        <input class="form-control" type="text" maxlength="50" name="titulo" value="" id="titulo" placeholder="Titulo"/>
                                    </div>
                                </div>
                                <div class="form-group has-feedback">
                                    <label for="descripcion" class="col-sm-2 required">Descripción</label>
                                    <div class="col-sm-6">
                                        <input type="text" maxlength="100" class="form-control" name="descripcion" id="descripcion" placeholder="Descripcion" />
                                    </div>
                                </div>
                                <div class="form-group has-feedback">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-offset-2 col-sm-6">
                                        <button id="crear_seccion" type="submit" class="btn btn-primary">Crear</button>
                                    </div>
                                </div>
                            </form>
