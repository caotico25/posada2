...
<html>
    ...
    <head>
        ...
        <title>Posada del Caos - Nuevo post</title>
                ...
                <div class="container">
                    ...
                    <div id="navbar" class="navbar-collapse collapse">
                        <ul class="nav navbar-nav">
                            ...
                            <li><a href="<?= base_url('noticias/novedades') ?>">Noticias</a></li>
            ...
            <div class="container rellenar">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="<?= base_url('foro/' . $tema['id']) ?>"><?= $tema['titulo'] ?></a></li>
                ...
                <section class="content">
                    ...
                    <article class="box">
                        <div class="box-header with-border">
                            <h3 class="box-title">Datos del nuevo post</h3>
                        </div>
                        <div class="box-body">
                            ...
                            <form role="form" class="form-horizontal">
                                ...
                                <div class="form-group has-feedback">
                                    <label for="descripcion" class="col-sm-2 required">Contenido</label>
                                    <div class="col-sm-6">
        ...
        <script type="text/javascript" charset="utf-8">
            ...
            $(document).ready(function() {
                ...
                $("#crear_seccion").on('click', function(event) {
                    ...
                    if (titulo_valido && descripcion_valido)
                    {
                        $.ajax({
                        
                            url: "<?= base_url('foro/alta_post') ?>",
                            type: "POST",
                            data: { 'titulo': titulo, 'descripcion': descripcion, 'tema': <?= $tema['id'] ?> },
                            success: function (respuesta){
                                
                                window.location.href = "<?= base_url('foro/' . $tema['id']) ?>";
