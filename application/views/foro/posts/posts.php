...
<html>
    ...
    <head>
        ...
        <title>Posada del Caos - Posts</title>
            ...
            <div class="container">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Administración de posts</li>
                    </ol>
                </section>
                            ...
                            <table id="tabla" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <?php foreach ($posts as $post): ?>
                                        <tr>
                                            <td><?= $post['titulo'] ?></td>
                                            <td><?= $post['autor']['usuario'] ?></td>
                                            <td><?= $post['tema']['titulo'] ?></td>
                                            <td><?= count($post['comentarios']) ?></td>
                                            <td>
                                                <span data-toggle="modal" data-target="#modal_eliminar">
                                                    <button class="eliminar btn btn-sm btn-default" data-href="<?= base_url('foro/eliminar_post/' . $post['id']) ?>" data-toggle="tooltip" title="Eliminar"><i class="fa fa-trash"></i></a>
                                                </span>
                                            </td>
                                        </tr>
                                    <?php endforeach ?>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>¡Atención! Si elimina este post se eliminarán tambien sus comentarios.</p>
                    </div>
