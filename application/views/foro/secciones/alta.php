...
<html>
    ...
    <head>
        ...
        <title>Posada del Caos - Alta de sección</title>
                ...
                <section class="content">
                    ...
                    <article class="box">
                        <div class="box-header with-border">
                            <h3 class="box-title">Datos de la nueva sección</h3>
                        </div>
                        <div class="box-body">
                ...
                $("#crear_seccion").on('click', function(event) {
                    ...
                    if (titulo_valido && descripcion_valido)
                    {
                        $.ajax({
                            ...
                            url: "<?= base_url('foro/alta_seccion') ?>",
                            type: "POST",
                            data: { 'titulo': titulo, 'descripcion': descripcion },
                            success: function (respuesta){
                                
                                window.location.href = "<?= base_url('foro/administrar_secciones') ?>";
