...
<html>
    ...
    <head>
        ...
        <title>Posada del Caos - Secciones</title>
                    ...
                    <article class="box">
                        <div class="box-header with-border">
                            ...
                            <div class="box-tools pull-right">
                                <a href="<?= base_url('foro/nueva_seccion') ?>" class="btn btn-box-tool" data-toggle="tooltip" title="Nueva sección"><i class="fa fa-plus"> Nueva</i></a>
                            </div>
                        </div>
                        <div class="box-body">
                                ...
                                <tbody>
                                    <?php foreach ($secciones as $seccion): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-sm btn-default" href="<?= base_url('foro/editar_seccion/' . $seccion['id']) ?>" data-toggle="tooltip" title="Editar"><i class="fa fa-edit"></i></a>
                                                <span data-toggle="modal" data-target="#modal_eliminar">
                                                    <button class="eliminar btn btn-sm btn-default" data-href="<?= base_url('foro/eliminar_seccion/' . $seccion['id']) ?>" data-toggle="tooltip" title="Eliminar"><i class="fa fa-trash"></i></a>
                                                </span>
                                            </td>
                                        </tr>
                                    <?php endforeach ?>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>¡Atención! Si elimina esta sección se eliminarán tambien sus temas y posts.</p>
                    </div>
