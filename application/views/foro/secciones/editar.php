...
<html>
    ...
    <head>
        ...
        <title>Posada del Caos - Editar sección</title>
            ...
            <div class="container rellenar">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Editare sección</li>
                    </ol>
                </section>
                        ...
                        <div class="box-body">
                            ...
                            <form role="form" class="form-horizontal">
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="col-sm-6">
                                        <input class="form-control" type="text" name="titulo" value="<?= $seccion['titulo'] ?>" id="titulo" placeholder="Titulo"/>
                                    </div>
                                </div>
                                <div class="form-group has-feedback">
                                    <label for="descripcion" class="col-sm-2 required">Descripción</label>
                                    <div class="col-sm-6">
                                        <input type="text" maxlength="100" class="form-control" name="descripcion" value="<?= $seccion['descripcion'] ?>" id="descripcion" placeholder="Descripcion" />
                                    </div>
                                </div>
                ...
                $("#crear_seccion").on('click', function(event) {
                    ...
                    if (titulo_valido && descripcion_valido)
                    {
                        $.ajax({
                            ...
                            url: "<?= base_url('foro/edit_seccion/' . $seccion['id']) ?>",
                            type: "POST",
