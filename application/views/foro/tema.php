...
<html lang="es">
    ...
    <head>
        ...
        <title>Posada del Caos - <?= $tema['titulo'] ?></title>
                ...
                <section class="box sombreado">
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools pull-left">
                            <a href="<?= base_url('foro/nuevo_post/' . $tema['id']) ?>" class="btn btn-box-tool" data-toggle="tooltip" title="Nuevo post"><i class="fa fa-plus"> Nuevo post</i></a>
                        </div>
                    </div>
                        ...
                        <table class="table table-hover">
                            <tbody>
                                <?php foreach ($posts as $post): ?> 
                                    <tr>
                                        <td class="clickable" data-href="<?= base_url('foro/' . $tema['id'] . '/' . $post['id']) ?>">
                                            <?= $post['titulo'] ?> <span class="pull-right">Por: <?= $post['autor']['usuario'] ?>. <span class="label label-default"><?= count($post['comentarios']) ?> respuestas</span></span>
                                        </td>
                                    </tr>
                                <?php endforeach ?>
                            </tbody>
